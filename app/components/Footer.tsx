...
const socialLinks = [
  {
    name: "Twitter",
    url: "https://twitter.com/10pointsBraille",
    icon: (
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/tenpoints_braille/",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/10pointsbraille/",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/tenpoints-braille-9753a7180/",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export default function Footer() {
  return (
    <footer className="w-full bg-black text-white py-8">
      ...
      {/* Social Media Links - At the end for both mobile and desktop */}
