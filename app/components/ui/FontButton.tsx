  ...
  return (
    <Link href={href}>
      <button className="group relative h-32 w-32 overflow-hidden rounded-full shadow-md transition-all duration-200 hover:shadow-[0_10px_25px_rgba(0,0,0,0.5)] md:h-24 md:w-24 lg:h-28 lg:w-28">
        {/* Image - Fills the button, hidden on hover */}
        <div className="absolute inset-0 flex items-center justify-center bg-white transition-opacity duration-200 group-hover:opacity-0">
        ...
        <div className="absolute inset-0 flex items-center justify-center rounded-full border-6 border-white bg-black opacity-0 transition-opacity duration-200 group-hover:opacity-100">
